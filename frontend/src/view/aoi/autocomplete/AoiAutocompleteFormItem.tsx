...
import AoiFormModal from 'src/view/aoi/form/AoiFormModal';
import AutocompleteInMemoryFormItem from 'src/view/shared/form/items/AutocompleteInMemoryFormItem';
import { useFormContext } from 'react-hook-form';
import { useSelector } from 'react-redux';
import selectors from 'src/modules/aoi/aoiSelectors';

function AoiAutocompleteFormItem(props) {
  ...
  const fetchFn = (value, limit) => {
    return AoiService.listAutocomplete(value, limit);
  };
...
export default AoiAutocompleteFormItem;
